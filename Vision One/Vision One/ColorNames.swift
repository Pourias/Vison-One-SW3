...
//  VisionOne
//
//  Created by Pouria Sanae on 8/2/16.
...
class ColorNames {
    ...
    func rgb2name(red: Float, green: Float, blue: Float)->String{
        ...
        let colorName : NSArray = getNeighbors(trainingSet: self.trainSet, testInstance: testInstance)[0] as! NSArray
        return  colorName[3] as! String
    }
